...
import com.dvidr.storm.bolt.{MyReportBolt, WordCountBolt, SplitSentenceBolt}
import storm.kafka.{SpoutConfig, ZkHosts, KafkaSpout}

object WordCountTopology {
  val SENTENCE_SPOUT_ID = "kafka-sentence-spout"
  val SPLIT_BOLT_ID = "split-bolt"
  val COUNT_BOLT_ID = "count-bolt"
  val REPORT_BOLT_ID = "report-bolt"
  val TOPOLOGY_NAME = "word-count-topology"
